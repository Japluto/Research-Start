...
# ===== ROS2 manual activation for avoiding Conda/Python conflicts =====
ros2_default_on() {
    source /opt/ros/humble/setup.bash
    if [ -f ~/ROS2_study/dev_ws/install/local_setup.sh ]; then
        source ~/ROS2_study/dev_ws/install/local_setup.sh
    fi
    echo "[ROS2] Humble + dev_ws loaded."
}

alias ros2_default='ros2_default_on'
...
gridmm_clean_on() {
    ...
    echo "[GridMM] Clean non-ROS shell prepared."
}

alias gridmm_on='gridmm_clean_on'